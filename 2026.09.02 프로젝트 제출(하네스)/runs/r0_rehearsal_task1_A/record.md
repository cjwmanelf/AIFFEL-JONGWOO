# run 기록: r0_rehearsal_task1_A

<!-- DATA -->
run_id: r0_rehearsal_task1_A
task: 1
condition: A
seq: 0
excluded: yes
started_at: 2026-09-02T08:39:56.719000+00:00
ended_at: 2026-09-02T08:42:28.105000+00:00
wall_seconds: 151.4
wait_seconds:
approvals: 1
approvals_bash: 1
...
- Bash 호출 2건, 그중 규칙에 안 걸려 승인이 필요한 호출 1건

| # | 규칙 허용 | 지연(s) | 승인 유발 조각 | 명령 (cd 접두사 제거) |
|---|---|---|---|---|
| 1 | O | 1.2 | - | `ls -la; echo "---"; cat TASK.md` |
| 2 | 승인 필요 | 134.1 | `python verify.py` | `python verify.py` |
