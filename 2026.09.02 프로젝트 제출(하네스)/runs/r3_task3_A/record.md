...
seq: 3
excluded: no
started_at: 2026-09-02T11:59:33.941000+00:00
ended_at: 2026-09-02T11:59:59.552000+00:00
wall_seconds: 25.6
wait_seconds:
approvals: 1
approvals_bash: 1
...
|---|---|---|---|---|
| 1 | O | 1.1 | - | `ls -la && echo "---TASK---" && cat TASK.md` |
| 2 | 승인 필요 | 3.6 | `python verify.py` | `python verify.py` |
